...
export interface ImageCropDialogProps {
    ...
    onDoneAll: () => void;
    setCroppedImageFor: (id: number, crop: Point, // Use Point type for consistency
    zoom: number, aspect: AspectRatio, // Use AspectRatio type directly
    fileUrl: string, createdFile: File) => void;
    images: Image[];
    currentImage: string;
